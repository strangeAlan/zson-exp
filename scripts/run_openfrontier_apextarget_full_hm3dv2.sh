...
RUN_ID="${ZSON3_RUN_ID:-openfrontier_apextarget_v1_deterministic_full_hm3dv2_1000_seed${SEED}}"
...
printf '[ZSON3 LAUNCH] OF-ApexTarget-v1 deterministic full_hm3dv2 run_id=%s\n' "${RUN_ID}" \
